...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Lee el archivo JSON
    $jsonString = file_get_contents('../data/json/answers.json');
    ...
    file_put_contents('../data/json/answers.json', json_encode(array_values($filteredAnswers)));
